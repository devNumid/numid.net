			...
			<div class="card-body p-4 p-sm-5" style="z-index:100;">
				<div class="row text-left justify-content-between align-items-center mb-2">
					<form id="frm-createwallet" data-url="/createwallet/register" data-method="post" data-selector="label" class="needs-validation" novalidate>
						...
						<div id="g-section" class="showdiv">
							<div class="text-center">
								<div class="input-group mt-2">
									<textarea id="mnemonic" type="text" class="form-control mt-2" name="mnemonic" placeholder="Mnemonic words" rows="4" cols="40" style="overflow:hidden;resize:none;" data-selector="serialize" readonly></textarea>
						...
						<div id="m-section" class="hidediv">
							<div class="text-center">
								<div class="form-group mt-2">
									<input type="password" class="form-control" name="passphrase" placeholder="Passphrase" maxlength="50" required>
									<div class="valid-feedback text-left"></div>
									<div id="c-txtpwd" class="invalid-feedback tdata-ext-left">Please fill out this field with at minimum 10 characters.</div>
								</div>
								<div class="form-group mt-2">
									<input type="password" class="form-control" name="cpassphrase" placeholder="Passphrase confirmation" maxlength="50" required>
									<div class="valid-feedback text-left"></div>
