	...
	<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3 pe-md-2">
		<div class="card h-md-100">
			<div class="card-header pb-0">
				<h6 class="mb-0 mt-2 d-flex align-items-center">Wallet unavailable</h6>
			</div>
			...
			<div class="card-body d-flex" style="z-index:100;">
				<div class="row flex-grow-1">
					<div class="col">
						<div class="mt-4">
							<h2>INFO</h2>
							<p>Due to an update numid wallet are temporarily unavailable please try to login later.</p>														
						</div>
					</div>
				</div>
			</div>
