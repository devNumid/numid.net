				...
				<form id="frm-openwallet" data-url="/openwallet/open" data-method="post" data-selector="label" class="needs-validation" novalidate>
					...
					<div class="text-center">
						<div class="form-group mt-2">
							<textarea type="text" class="form-control" name="mnemonic" placeholder="Mnemonic words" rows="4" cols="50" style="overflow:hidden;resize:none;" data-selector="serialize" ></textarea>
